...
class ORACC(Corpus):
    def __init__(self, oracc_dir, tqdm=tqdm):
        ...
        transliterated_oracc_pids_and_oids = [(x["corpus"]["project"], x["corpus"]["textid"]) for x in
                                              transliterated_oracc_corpi.values()]
        ...
        self.init_pubs()
    # I'm sorry for the spagetti code. not really tho.
